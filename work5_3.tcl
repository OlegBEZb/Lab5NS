...
#Вывод текущих значений времени моделирования (time), последовательного номера передаваемого пакета (t_seqno),окна переполнения (cwnd), границы медленного старта (ssthresh) и наивысшего значения из полученных подтверждений от приемника (ack)
...
# Подготовка файла с информацией о параметрах протокола
